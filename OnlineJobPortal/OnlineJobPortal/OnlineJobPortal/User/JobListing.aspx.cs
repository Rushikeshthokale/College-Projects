        ...
        protected void lbFilter_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (isCondition)
                {
                    ...
                    {
                        subquery += a + " and "; // Country = 'India' and JobType IN (Full Time, Part Time) 
                    }
                ...
                {
                    query = @"Select JobId,Title,Salary,JobType,CompanyName,CompanyImage,Country,State,CreatedDate from Jobs";
                }
